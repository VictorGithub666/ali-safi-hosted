...
os.makedirs('resources/views/admin/customers', exist_ok=True)
os.makedirs('resources/views/admin/vendors', exist_ok=True)
os.makedirs('resources/views/admin/riders', exist_ok=True)
os.makedirs('resources/views/admin/prices', exist_ok=True)
os.makedirs('resources/views/admin/finances', exist_ok=True)
os.makedirs('resources/views/admin/orders', exist_ok=True)

# AdminRiderController
rider_controller = open('app/Http/Controllers/Admin/AdminRiderController.php', 'w')
rider_controller.write("""<?php
...
""")
rider_controller.close()

print("✓ Created AdminRiderController.php")
